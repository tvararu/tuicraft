...
Subagent-driven. Execute the plan. Branch, implement, open PR. When completely finished, run: openclaw system event --text "Done: Mail notifications (SMSG_RECEIVED_MAIL)" --mode now
