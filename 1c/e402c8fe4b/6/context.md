...
Read docs/plans/2026-03-01-chat-notices.md and execute it. Create a feature branch, implement everything per the plan, commit with conventional commit style (feat: prefix), and open a PR against main. When completely finished, run: openclaw system event --text "Done: chat notices (SMSG_CHAT_RESTRICTED + SMSG_CHAT_WRONG_FACTION)" --mode now
...
Show me your progress. What did you do? Did you open a PR?
