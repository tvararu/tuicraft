...
**Reference:** `../wow-chat-client` for packet formats. `docs/plans/2026-02-18-v2-chat-design.md` for full design. `../azerothcore-wotlk-playerbots/` for server implementation.
