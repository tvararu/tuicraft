...
* Show readable encounter, loot, recovery, and inventory summaries without `--json`.
* Distinguish daemon request acceptance from server-confirmed results in human output.
